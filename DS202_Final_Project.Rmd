...
plotly_scatter <- merged_data %>%
  plot_ly(x = ~`Owner Occupied`, y = ~Employed, text = ~NAME, mode = "markers") %>%
...
```{r}
ggplot(merged_data, aes(x=reorder(state, EmploymentRate), y=EmploymentRate)) +
  geom_bar(stat="identity") +
  coord_flip() +
  labs(title="State-wise Employment Rates",
       x="State",
       y="Employment Rate")
